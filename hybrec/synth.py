...
__all__ = ['SynthDatasetGenerator', 'gen_values', 'gen_added_n_deleted', 'exclude_element', 'build_interactions',
...
# Cell
@patch
def build_synth_dataset(self:SynthDatasetGenerator,
                        n_users:int = 10,
                        n_items:int = 10,
                        max_added:int = 3,
                        max_deleted:int = 3,
...
# Cell
@patch
def build_user_item_interactions(self:SynthDatasetGenerator,
                                 new:bool = False,
                                 sparsity:float = 0.5,
                                 feedback:bool = True,
